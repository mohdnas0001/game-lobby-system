...
Create a .env file in the backend root:PORT=5000
...
Run the Backend Locally:yarn start
...
Clone the Frontend Repository:git clone https://github.com/your-username/game-lobby-frontend.git
...
Configure Environment Variables:
Create a .env file in the frontend root:VITE_API_URL=https://game-lobby-backend-9d4k.onrender.com




Run the Frontend Locally:yarn dev
...
Unit Tests (Frontend):cd game-lobby-frontend
yarn test


End-to-End Tests (if implemented):yarn e2e-test


Backend Tests (if implemented):cd game-lobby-backend
yarn test
...
Demo Link
Live DemoNote: Replace with the actual Vercel URL after deployment.
Repository
